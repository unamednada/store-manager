...
describe('Testes das camadas Model, Service e Controller', () => {
  ...
  describe('Escreva testes para cobrir 35% das camadas da sua aplicação', () => {
  ...
  describe('Escreva testes para cobrir 40% das camadas da sua aplicação', () => {
  ...
  describe('Escreva testes para cobrir 50% das camadas da sua aplicação', () => {
  ...
  describe('Escreva testes para cobrir 60% das camadas da sua aplicação', () => {
